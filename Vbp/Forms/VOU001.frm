...
Private Function cmdSave() As Boolean
    ...
    Call SetSPPara(adcmdSave, 3, txtVouLen)
    Call SetSPPara(adcmdSave, 4, txtVouLastKey)
    
    adcmdSave.Execute
    wsNo = GetSPPara(adcmdSave, 5)
...
Private Sub cboVouPrefix_KeyPress(KeyAscii As Integer)
    Call chk_InpLen(cboVouPrefix, 3, KeyAscii)
...
Private Sub cboVouPrefix_DropDown()
    ...
    wsSql = "SELECT VouPrefix, VouLen FROM sysVouNo WHERE "
