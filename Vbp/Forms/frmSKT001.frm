...
Begin VB.Form frmSKT001 
   Caption         =   "訂貨單"
   ClientHeight    =   8820
   ClientLeft      =   1.96650e5
   ClientTop       =   270
   ClientWidth     =   11265
   Icon            =   "frmSKT001.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   8820
   ScaleWidth      =   11265
   ...
   Begin TrueDBGrid60.TDBGrid tblCommon 
      Height          =   2070
      Left            =   7200
      OleObjectBlob   =   "frmSKT001.frx":030A
      TabIndex        =   9
      Top             =   4200
      Visible         =   0   'False
      Width           =   4935
   End
   Begin VB.ComboBox cboScNo 
      Height          =   300
      Left            =   5760
      TabIndex        =   24
      Top             =   1440
   ...
   Begin MSComctlLib.ImageList iglProcess 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSKT001.frx":2A0D
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSKT001.frx":32E7
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSKT001.frx":3BC1
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSKT001.frx":4013
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSKT001.frx":4465
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSKT001.frx":477F
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSKT001.frx":4BD1
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSKT001.frx":5023
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSKT001.frx":533D
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSKT001.frx":5657
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSKT001.frx":5AA9
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSKT001.frx":6385
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSKT001.frx":66AD
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin TrueDBGrid60.TDBGrid tblDetail 
      Height          =   4515
      Left            =   120
      OleObjectBlob   =   "frmSKT001.frx":69CD
      TabIndex        =   8
      Top             =   3480
      Width           =   11535
   End
...
Private Function LoadRecord() As Boolean
    ...
    With waResult
        ...
        Do While Not rsInvoice.EOF
            ...
            waResult(.UpperBound(1), SOH) = Format(ReadRs(rsInvoice, "SJDTONHAND"), gsQtyFmt)
            waResult(.UpperBound(1), QTY) = Format(ReadRs(rsInvoice, "SJDTCOUNTED"), gsQtyFmt)
            waResult(.UpperBound(1), PRICE) = Format(ReadRs(rsInvoice, "SJDTUPRICE"), gsUprFmt)
            waResult(.UpperBound(1), ADJ) = Format(ReadRs(rsInvoice, "SJDTTRNQTY"), gsAmtFmt)
...
On Error GoTo Ini_Caption_Err
    ...
    lblScNo.Caption = Get_Caption(waScrItm, "SCNO")
    ...
    If waResult.UpperBound(1) >= 0 Then
        ...
        For wiCtr = 0 To waResult.UpperBound(1)
            If Trim(waResult(wiCtr, ITMCODE)) <> "" Then
                ...
                If To_Value(waResult(wiCtr, QTY)) > To_Value(waResult(wiCtr, SOH)) Then
                    wsTrnType = "STKIN"
                    wdQty = To_Value(waResult(wiCtr, QTY)) - To_Value(waResult(wiCtr, SOH))
                Else
                    wsTrnType = "STKOUT"
                    wdQty = To_Value(waResult(wiCtr, SOH)) - To_Value(waResult(wiCtr, QTY))
                ...
                Call SetSPPara(adcmdSave, 5, To_Value(waResult(wiCtr, QTY)))
                ...
                Call SetSPPara(adcmdSave, 10, cboMLCode.Text)
                Call SetSPPara(adcmdSave, 11, waResult(wiCtr, SOH))
...
Private Function InputValidation() As Boolean
  ...
  '  If Not Chk_cboSaleCode Then Exit Function
    ...
    If Chk_MLClass(cboMLCode, "G", "") = False Then
        gsMsg = "沒有此會計分類!"
        MsgBox gsMsg, vbOKOnly, gsTitle
        cboMLCode.SetFocus
       Exit Function
    ...
    With tblDetail
        Select Case ColIndex
            ...
            Case ITMCODE
                ...
                .Columns(SOH).Text = Get_IcTrnQty("STKQTY", wsITMID, cboWhsCodeFr.Text, "")
             ...
             Case LOTNO
                ...
                If Chk_LotEnabled(cboWhsCodeFr.Text) = True Then
                     .Columns(SOH).Text = Get_IcTrnQty("STKQTY", .Columns(ITMID).Text, cboWhsCodeFr.Text, .Columns(ColIndex).Text)
                End If
            ...
            Case QTY
                ...
                If ColIndex = QTY Then
                    If Chk_grdQty(.Columns(ColIndex).Text) = False Then
                        GoTo Tbl_BeforeColUpdate_Err
                    Else
                        .Columns(ADJ).Text = Format(To_Value(.Columns(QTY).Text) - To_Value(.Columns(SOH).Text), gsAmtFmt)
                    End If
                End If
...
Private Function Calc_Total(Optional ByVal LastRow As Variant) As Boolean
    ...
    For wiRowCtr = 0 To waResult.UpperBound(1)
        ...
        wdTotalPrice = wdTotalPrice + To_Value(waResult(wiRowCtr, ADJ))
    Next
...
Private Sub cboScNo_DropDown()
    ...
    wsSQL = wsSQL & " AND SCHDDOCNO LIKE '%" & IIf(cboScNo.SelLength > 0, "", Set_Quote(cboScNo.Text)) & "%' "
    wsSQL = wsSQL & "ORDER BY SCHDDOCNO "
    Call Ini_Combo(2, wsSQL, cboScNo.Left, cboScNo.Top + cboScNo.Height, tblCommon, wsFormID, "TBLSCNO", Me.Width, Me.Height)
...
Private Sub cboScNo_GotFocus()
    FocusMe cboScNo
End Sub

Private Sub cboScNo_KeyPress(KeyAscii As Integer)
...
Private Sub cboScNo_LostFocus()
    FocusMe cboScNo, True
End Sub

Private Function Get_SCID() As Long
    Dim wsSQL As String
    Dim rsDes As New ADODB.Recordset
