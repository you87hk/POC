...
Begin VB.Form frmPGV001 
   Caption         =   "訂貨單"
   ClientHeight    =   8595
   ClientLeft      =   1.96650e5
   ClientTop       =   270
   ClientWidth     =   11880
   Icon            =   "frmPGV001.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   ScaleHeight     =   8595
   ScaleWidth      =   11880
   ...
   Begin TrueDBGrid60.TDBGrid tblCommon 
      Height          =   2070
      Left            =   11400
      OleObjectBlob   =   "frmPGV001.frx":030A
      TabIndex        =   40
      Top             =   120
      Visible         =   0   'False
      Width           =   4575
   ...
   Begin MSComctlLib.ImageList iglProcess 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPGV001.frx":2A0D
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPGV001.frx":32E7
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPGV001.frx":3BC1
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPGV001.frx":4013
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPGV001.frx":4465
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPGV001.frx":477F
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPGV001.frx":4BD1
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPGV001.frx":5023
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPGV001.frx":533D
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPGV001.frx":5657
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPGV001.frx":5AA9
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPGV001.frx":6385
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPGV001.frx":66AD
            Key             =   ""
         EndProperty
         BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPGV001.frx":69CD
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin TabDlg.SSTab tabDetailInfo 
      ...
      TabPicture(0)   =   "frmPGV001.frx":6CE9
      ...
      TabPicture(1)   =   "frmPGV001.frx":6D05
      ...
      TabPicture(2)   =   "frmPGV001.frx":6D21
      ...
      Begin TrueDBGrid60.TDBGrid tblDetail 
         Height          =   6855
         Left            =   120
         OleObjectBlob   =   "frmPGV001.frx":717F
         TabIndex        =   21
         Top             =   840
         Width           =   11535
      End
...
Private Const wsKeyType = "popPvHd"
...
Private Sub cboDocNo_DropDown()
    ...
    wsSQL = wsSQL & " WHERE PVHDDOCNO LIKE '%" & IIf(cboDocNo.SelLength > 0, "", Set_Quote(cboDocNo.Text)) & "%' "
...
Private Function LoadRecord() As Boolean
    ...
    LoadRecord = False
        ...
        wsSQL = wsSQL & "WHERE PVHDDOCNO = '" & Set_Quote(cboDocNo) & "' "
    ...
    txtExcr.Text = Format(ReadRs(rsInvoice, "PVHDEXCR"), gsExrFmt)
    ...
    cboPayCode = ReadRs(rsInvoice, "PVHDPAYCODE")
    cboPrcCode = ReadRs(rsInvoice, "PVHDPRCCODE")
    cboMLCode = ReadRs(rsInvoice, "PVHDMLCODE")
    cboShipCode = ReadRs(rsInvoice, "PVHDSHIPCODE")
    cboRmkCode = ReadRs(rsInvoice, "PVHDRMKCODE")
    
    txtCusPo = ReadRs(rsInvoice, "PVHDCUSPO")
    txtLcNo = ReadRs(rsInvoice, "PVHDLCNO")
    txtPortNo = ReadRs(rsInvoice, "PVHDPORTNO")
    
    txtSpecDis = Format(ReadRs(rsInvoice, "PVHDSPECDIS"), gsExrFmt)
    txtDisAmt.Text = Format(To_Value(ReadRs(rsInvoice, "PVHDDISAMT")), gsAmtFmt)
    
    
    txtShipFrom = ReadRs(rsInvoice, "PVHDSHIPFROM")
    txtShipTo = ReadRs(rsInvoice, "PVHDSHIPTO")
    txtShipVia = ReadRs(rsInvoice, "PVHDSHIPVIA")
    txtShipName = ReadRs(rsInvoice, "PVHDSHIPNAME")
    txtShipPer = ReadRs(rsInvoice, "PVHDSHIPPER")
    txtShipAdr1 = ReadRs(rsInvoice, "PVHDSHIPADR1")
    txtShipAdr2 = ReadRs(rsInvoice, "PVHDSHIPADR2")
    txtShipAdr3 = ReadRs(rsInvoice, "PVHDSHIPADR3")
    txtShipAdr4 = ReadRs(rsInvoice, "PVHDSHIPADR4")
    
    Dim i As Integer
    
    For i = 1 To 10
        txtRmk(i) = ReadRs(rsInvoice, "PVHDRMK" & i)
    Next i
    ...
    With waResult
         ...
         Do While Not rsInvoice.EOF
             wiCtr = wiCtr + 1
             .AppendRows
             waResult(.UpperBound(1), LINENO) = ReadRs(rsInvoice, "PVDTDOCLINE")
             ...
             waResult(.UpperBound(1), WHSCODE) = ReadRs(rsInvoice, "PVDTWHSCODE")
             waResult(.UpperBound(1), LOTNO) = ReadRs(rsInvoice, "PVDTLOTNO")
             waResult(.UpperBound(1), PUBLISHER) = ""
             'waResult(.UpperBound(1), Qty) = Format(ReadRs(rsInvoice, "PVDTQTY"), gsQtyFmt)
             waResult(.UpperBound(1), QTY) = Format(ReadRs(rsInvoice, "PVDTQTY"), gsAmtFmt)
             waResult(.UpperBound(1), PRICE) = Format(ReadRs(rsInvoice, "PVDTUPRICE"), gsAmtFmt)
             waResult(.UpperBound(1), DisPer) = Format(ReadRs(rsInvoice, "PVDTDISPER"), gsAmtFmt)
             waResult(.UpperBound(1), Amt) = Format(ReadRs(rsInvoice, "PVDTAMT"), gsAmtFmt)
             waResult(.UpperBound(1), Amtl) = Format(ReadRs(rsInvoice, "PVDTAMTL"), gsAmtFmt)
             waResult(.UpperBound(1), Dis) = Format(ReadRs(rsInvoice, "PVDTDIS"), gsAmtFmt)
             waResult(.UpperBound(1), Disl) = Format(ReadRs(rsInvoice, "PVDTDISL"), gsAmtFmt)
             waResult(.UpperBound(1), NET) = Format(ReadRs(rsInvoice, "PVDTNET"), gsAmtFmt)
             waResult(.UpperBound(1), Netl) = Format(ReadRs(rsInvoice, "PVDTNETL"), gsAmtFmt)
             waResult(.UpperBound(1), ITMID) = ReadRs(rsInvoice, "PVDTITEMID")
             waResult(.UpperBound(1), POID) = ReadRs(rsInvoice, "PVDTPOID")
...
Private Function Chk_KeyExist() As Boolean
    ...
    wsSQL = "SELECT PVHDSTATUS FROM popPvHd WHERE PVHDDOCNO = '" & Set_Quote(cboDocNo) & "'"
    rspopPVHd.Open wsSQL, cnCon, adOpenStatic, adLockOptimistic
    ...
    With waResult
         ...
         Do While Not rsRcd.EOF
           ...
           '   wdBalQty = Get_PoBalQty(wsTrnCd, 0, ReadRs(rsRcd, "POHDDOCID"), ReadRs(rsRcd, "PODTITEMID"), ReadRs(rsRcd, "PODTWHSCODE"), ReadRs(rsRcd, "PODTLOTNO"))
             ...
             waResult(.UpperBound(1), QTY) = Format(ReadRs(rsRcd, "PODTBALQTY"), gsQtyFmt)
             ...
             waResult(.UpperBound(1), Amt) = Format(To_Value(ReadRs(rsRcd, "PODTUPRICE")) * To_Value(ReadRs(rsRcd, "PODTBALQTY")), gsAmtFmt)
             waResult(.UpperBound(1), Amtl) = Format(To_Value(ReadRs(rsRcd, "PODTUPRICE")) * To_Value(ReadRs(rsRcd, "PODTBALQTY")) * To_Value(txtExcr.Text), gsAmtFmt)
