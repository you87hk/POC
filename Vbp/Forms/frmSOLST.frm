...
Begin VB.Form frmSOLST 
   ...
   Begin TrueDBGrid60.TDBGrid tblCommon 
      Height          =   2070
      Left            =   8880
      OleObjectBlob   =   "frmSOLST.frx":0442
      TabIndex        =   8
      Top             =   2160
      Visible         =   0   'False
      Width           =   4575
   ...
   Begin MSComctlLib.ImageList iglProcess 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSOLST.frx":2B45
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSOLST.frx":341F
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSOLST.frx":3CF9
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSOLST.frx":414B
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSOLST.frx":459D
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSOLST.frx":48B7
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSOLST.frx":4D09
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSOLST.frx":515B
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSOLST.frx":5475
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSOLST.frx":578F
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSOLST.frx":5BE1
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSOLST.frx":64BD
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSOLST.frx":67E5
            Key             =   ""
         EndProperty
         BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSOLST.frx":6C39
            Key             =   ""
         EndProperty
         BeginProperty ListImage15 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSOLST.frx":6F5D
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin TrueDBGrid60.TDBGrid tblDetail 
      Height          =   5055
      Left            =   120
      OleObjectBlob   =   "frmSOLST.frx":7281
      TabIndex        =   6
      Top             =   1920
      Width           =   9855
   End
...
Public Property Let InCusID(inDocCus As Long)
     wlCusID = inDocCus
End Property
...
Private Sub cboDocNoFr_DropDown()
   Dim wsSql As String
    ...
    wsSql = wsSql & " FROM soaSOHD, soaSODT, mstCUSTOMER "
    ...
    wsSql = wsSql & " GROUP BY SOHDDOCNO, CUSCODE, SOHDDOCDATE "
    wsSql = wsSql & " HAVING SUM(SODTBALQTY) <> 0 "
...
Private Sub Ini_Scr()
   ...
   '             MyControl.Clear
    ...
    cboDocNoFr.Text = ""
    cboDocNoTo.Text = ""
    cboCusNoFr.Text = Get_TableInfo("MSTCUSTOMER", "CUSID = " & wlCusID, "CUSCODE")
    cboCusNoTo.Text = cboCusNoFr.Text
...
Private Function LoadRecord() As Boolean
    ...
    Me.MousePointer = vbHourglass
        ...
        wsSql = "SELECT  SOHDDOCNO, ITMCODE, SODTITEMID, SODTWHSCODE, SODTLOTNO, SODTITEMDESC ITNAME, SODTQTY, SODTBALQTY, SODTUPRICE, "
        wsSql = wsSql & " SODTDISPER, SODTAMT, SODTNET, SODTID, SODTDOCID "
...
'        wsSql = wsSql & "AND SODTBALQTY > 0 "
        wsSql = wsSql & "ORDER BY SODTDOCID, SODTDOCLINE "
    ...
    Do Until rsRcd.EOF
       ...
       wdBalQty = Get_SoBalQty(wsTrnCd, wlDocID, ReadRs(rsRcd, "SODTDOCID"), ReadRs(rsRcd, "SODTITEMID"), ReadRs(rsRcd, "SODTWHSCODE"), ReadRs(rsRcd, "SODTLOTNO"))

     .AppendRows
        waResult(.UpperBound(1), SSEL) = "0"
        waResult(.UpperBound(1), SDOCNO) = ReadRs(rsRcd, "SOHDDOCNO")
        waResult(.UpperBound(1), sItmCode) = ReadRs(rsRcd, "ITMCODE")
        waResult(.UpperBound(1), SITMDESC) = ReadRs(rsRcd, "ITNAME")
        waResult(.UpperBound(1), SWHSCODE) = ReadRs(rsRcd, "SODTWHSCODE")
        waResult(.UpperBound(1), SLOTNO) = ReadRs(rsRcd, "SODTLOTNO")
        waResult(.UpperBound(1), SUPRICE) = Format(To_Value(ReadRs(rsRcd, "SODTUPRICE")), gsAmtFmt)
        waResult(.UpperBound(1), SQTY) = Format(wdBalQty, gsQtyFmt)
        If wdBalQty = To_Value(ReadRs(rsRcd, "SODTQTY")) Then
        waResult(.UpperBound(1), SAMT) = Format(To_Value(ReadRs(rsRcd, "SODTAMT")), gsAmtFmt)
        waResult(.UpperBound(1), SNET) = Format(To_Value(ReadRs(rsRcd, "SODTNET")), gsAmtFmt)
        Else
        wdPrice = To_Value(ReadRs(rsRcd, "SODTUPRICE"))
        wdQty = wdBalQty
        wdAmt = Format(wdPrice * wdQty, gsAmtFmt)
        wdDis = Format(wdAmt * To_Value(ReadRs(rsRcd, "SODTDISPER")) / 100, gsAmtFmt)
        wdNet = wdAmt - wdDis
        waResult(.UpperBound(1), SAMT) = Format(wdAmt, gsAmtFmt)
        waResult(.UpperBound(1), SNET) = Format(wdNet, gsAmtFmt)
        End If
        waResult(.UpperBound(1), SID) = ReadRs(rsRcd, "SODTID")
    rsRcd.MoveNext
    Loop
    End With
    ...
    For wiCtr = 0 To waResult.UpperBound(1)
         If Trim(waResult(wiCtr, SSEL)) = "-1" Then
            If Trim(waResult(wiCtr, SID)) = "" Then Exit For
             If get_SOInfo(waResult(wiCtr, SID), wsBookID, wsBarCode, wsPub, wdPrice, wdQty, wdDisPer, wdAmt, wdDis, wdNet, wsSoId) = False Then Exit For
             .AppendRows
             waInvDoc(.UpperBound(1), LINENO) = wlLineNo
             waInvDoc(.UpperBound(1), SONO) = waResult(wiCtr, SDOCNO)
             ...
             waInvDoc(.UpperBound(1), SOID) = wsSoId
             wlLineNo = wlLineNo + 1
         End If
    Next wiCtr
    End If
...
Private Function get_SOInfo(inID As String, outBookID As String, OutBarCode As String, outPub As String, outPrice As Double, outQty As Double, outDisPer As Double, outAmt As Double, outDis As Double, outNet As Double, outSoID As String) As Boolean
   ...
   get_SOInfo = False
        ...
        wsSql = "SELECT SOHDDOCID, SOHDCURR, SOHDEXCR, ITMID, ITMBARCODE, ITMPUBLISHER, "
        wsSql = wsSql & "SODTUPRICE, SODTQTY, SODTBALQTY, SODTDISPER, SODTAMT, "
        wsSql = wsSql & "SODTAMTL, SODTDIS, SODTDISL, SODTNET, SODTNETL, SODTWHSCODE, SODTLOTNO "
        wsSql = wsSql & "FROM  SOASOHD,SOASODT, mstITEM "
        wsSql = wsSql & "WHERE SODTID =  " & inID & " "
        wsSql = wsSql & "AND SODTITEMID = ITMID "
        wsSql = wsSql & "AND SODTDOCID = SOHDDOCID "
   ...
   outSoID = ReadRs(rsRcd, "SOHDDOCID")
   outBookID = ReadRs(rsRcd, "ITMID")
   OutBarCode = ReadRs(rsRcd, "ITMBARCODE")
   outPub = ReadRs(rsRcd, "ITMPUBLISHER")
   lstPrice = To_Value(ReadRs(rsRcd, "SODTUPRICE"))
   lstQty = To_Value(ReadRs(rsRcd, "SODTQTY"))
   lstBalQty = Get_SoBalQty(wsTrnCd, wlDocID, outSoID, ReadRs(rsRcd, "ITMID"), ReadRs(rsRcd, "SODTWHSCODE"), ReadRs(rsRcd, "SODTLOTNO"))
   lstCurr = ReadRs(rsRcd, "SOHDCURR")
   lstExcr = To_Value(ReadRs(rsRcd, "SOHDEXCR"))
   outDisPer = To_Value(ReadRs(rsRcd, "SODTDISPER"))
   outQty = lstBalQty
   If Trim(UCase(wsCurr)) = Trim(UCase(lstCurr)) And lstQty = lstBalQty Then
        outPrice = lstPrice
        outAmt = To_Value(ReadRs(rsRcd, "SODTAMT"))
        outDis = To_Value(ReadRs(rsRcd, "SODTDIS"))
        outNet = To_Value(ReadRs(rsRcd, "SODTNET"))
   Else
