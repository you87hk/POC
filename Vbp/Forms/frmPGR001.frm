...
Begin VB.Form frmPGR001 
   Caption         =   "訂貨單"
   ClientHeight    =   8595
   ClientLeft      =   1.96650e5
   ClientTop       =   270
   ClientWidth     =   11880
   Icon            =   "frmPGR001.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   ScaleHeight     =   8595
   ScaleWidth      =   11880
   ...
   Begin TrueDBGrid60.TDBGrid tblCommon 
      Height          =   2070
      Left            =   11400
      OleObjectBlob   =   "frmPGR001.frx":030A
      TabIndex        =   37
      Top             =   120
      Visible         =   0   'False
      Width           =   4575
   ...
   Begin MSComctlLib.ImageList iglProcess 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPGR001.frx":2A0D
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPGR001.frx":32E7
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPGR001.frx":3BC1
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPGR001.frx":4013
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPGR001.frx":4465
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPGR001.frx":477F
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPGR001.frx":4BD1
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPGR001.frx":5023
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPGR001.frx":533D
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPGR001.frx":5657
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPGR001.frx":5AA9
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPGR001.frx":6385
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPGR001.frx":66AD
            Key             =   ""
         EndProperty
         BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPGR001.frx":69CD
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin TabDlg.SSTab tabDetailInfo 
      ...
      TabPicture(0)   =   "frmPGR001.frx":6CE9
      ...
      Tab(0).Control(5)=   "cboMLCode"
      Tab(0).Control(6)=   "cboPrcCode"
      Tab(0).Control(7)=   "cboPayCode"
      Tab(0).Control(8)=   "cboVdrCode"
      Tab(0).Control(9)=   "cboDocNo"
      Tab(0).Control(10)=   "cboRefDocNo"
      Tab(0).ControlCount=   11
      TabCaption(1)   =   "Shipment "
      TabPicture(1)   =   "frmPGR001.frx":6D05
      ...
      TabPicture(2)   =   "frmPGR001.frx":6D21
      ...
      Begin TrueDBGrid60.TDBGrid tblDetail 
         Height          =   6855
         Left            =   120
         OleObjectBlob   =   "frmPGR001.frx":6D3D
         TabIndex        =   18
         Top             =   840
         Width           =   11535
      End
...
Private Const wsKeyType = "popPRHD"
...
Private Sub cboDocNo_DropDown()
    ...
    wsSQL = wsSQL & " WHERE PRHDDOCNO LIKE '%" & IIf(cboDocNo.SelLength > 0, "", Set_Quote(cboDocNo.Text)) & "%' "
...
Private Function LoadRecord() As Boolean
    ...
    LoadRecord = False
        ...
        wsSQL = wsSQL & "WHERE PRHDDOCNO = '" & Set_Quote(cboDocNo) & "' "
    ...
    txtExcr.Text = Format(ReadRs(rsInvoice, "PRHDEXCR"), gsExrFmt)
    ...
    cboPayCode = ReadRs(rsInvoice, "PRHDPAYCODE")
    cboPrcCode = ReadRs(rsInvoice, "PRHDPRCCODE")
    cboMLCode = ReadRs(rsInvoice, "PRHDMLCODE")
    cboShipCode = ReadRs(rsInvoice, "PRHDSHIPCODE")
    cboRmkCode = ReadRs(rsInvoice, "PRHDRMKCODE")
    
    txtCusPo = ReadRs(rsInvoice, "PRHDCUSPO")
    txtLcNo = ReadRs(rsInvoice, "PRHDLCNO")
    txtPortNo = ReadRs(rsInvoice, "PRHDPORTNO")
    
    
    txtShipFrom = ReadRs(rsInvoice, "PRHDSHIPFROM")
    txtShipTo = ReadRs(rsInvoice, "PRHDSHIPTO")
    txtShipVia = ReadRs(rsInvoice, "PRHDSHIPVIA")
    txtShipName = ReadRs(rsInvoice, "PRHDSHIPNAME")
    txtShipPer = ReadRs(rsInvoice, "PRHDSHIPPER")
    txtShipAdr1 = ReadRs(rsInvoice, "PRHDSHIPADR1")
    txtShipAdr2 = ReadRs(rsInvoice, "PRHDSHIPADR2")
    txtShipAdr3 = ReadRs(rsInvoice, "PRHDSHIPADR3")
    txtShipAdr4 = ReadRs(rsInvoice, "PRHDSHIPADR4")
    
    Dim i As Integer
    
    For i = 1 To 10
        txtRmk(i) = ReadRs(rsInvoice, "PRHDRMK" & i)
    Next i
    ...
    With waResult
         ...
         Do While Not rsInvoice.EOF
             wiCtr = wiCtr + 1
             .AppendRows
             waResult(.UpperBound(1), LINENO) = ReadRs(rsInvoice, "PRDTDOCLINE")
             ...
             waResult(.UpperBound(1), WHSCODE) = ReadRs(rsInvoice, "PRDTWHSCODE")
             waResult(.UpperBound(1), LOTNO) = ReadRs(rsInvoice, "PRDTLOTNO")
             waResult(.UpperBound(1), PUBLISHER) = ""
           '  waResult(.UpperBound(1), Qty) = Format(ReadRs(rsInvoice, "PRDTQTY"), gsQtyFmt)
             waResult(.UpperBound(1), QTY) = Format(ReadRs(rsInvoice, "PRDTQTY"), gsAmtFmt)
             waResult(.UpperBound(1), PRICE) = Format(ReadRs(rsInvoice, "PRDTUPRICE"), gsAmtFmt)
             waResult(.UpperBound(1), DisPer) = Format(ReadRs(rsInvoice, "PRDTDISPER"), gsAmtFmt)
             waResult(.UpperBound(1), Amt) = Format(ReadRs(rsInvoice, "PRDTAMT"), gsAmtFmt)
             waResult(.UpperBound(1), Amtl) = Format(ReadRs(rsInvoice, "PRDTAMTL"), gsAmtFmt)
             waResult(.UpperBound(1), Dis) = Format(ReadRs(rsInvoice, "PRDTDIS"), gsAmtFmt)
             waResult(.UpperBound(1), Disl) = Format(ReadRs(rsInvoice, "PRDTDISL"), gsAmtFmt)
             waResult(.UpperBound(1), NET) = Format(ReadRs(rsInvoice, "PRDTNET"), gsAmtFmt)
             waResult(.UpperBound(1), Netl) = Format(ReadRs(rsInvoice, "PRDTNETL"), gsAmtFmt)
             waResult(.UpperBound(1), ITMID) = ReadRs(rsInvoice, "PRDTITEMID")
             waResult(.UpperBound(1), POID) = ReadRs(rsInvoice, "PRDTPOID")
...
Private Function Chk_KeyExist() As Boolean
    ...
    wsSQL = "SELECT PRHDSTATUS FROM popPRHD WHERE PRHDDOCNO = '" & Set_Quote(cboDocNo) & "'"
    rspopPRHD.Open wsSQL, cnCon, adOpenStatic, adLockOptimistic
...
Private Function Get_RefDoc() As Boolean
    ...
    txtPortNo = ReadRs(rsRcd, "POHDPORTNO")
    ...
    With waResult
         ...
         Do While Not rsRcd.EOF
             ...
             waResult(.UpperBound(1), QTY) = Format(wdBalQty, gsAmtFmt)
             ...
             waResult(.UpperBound(1), Amt) = Format(ReadRs(rsRcd, "PODTAMT"), gsAmtFmt)
             waResult(.UpperBound(1), Amtl) = Format(ReadRs(rsRcd, "PODTAMTL"), gsAmtFmt)
             waResult(.UpperBound(1), Dis) = Format(ReadRs(rsRcd, "PODTDIS"), gsAmtFmt)
             waResult(.UpperBound(1), Disl) = Format(ReadRs(rsRcd, "PODTDISL"), gsAmtFmt)
             waResult(.UpperBound(1), NET) = Format(ReadRs(rsRcd, "PODTNET"), gsAmtFmt)
             waResult(.UpperBound(1), Netl) = Format(ReadRs(rsRcd, "PODTNETL"), gsAmtFmt)
