...
Begin VB.Form frmTRF001 
   ...
   Begin VB.Frame fraKey 
      ...
      Begin VB.TextBox txtRmk3 
         ...
         Width           =   6840
      End
      Begin VB.CommandButton btnITMLST 
         Caption         =   "ITEMPRICE"
         Height          =   675
         Left            =   9720
         TabIndex        =   10
   ...
   Begin MSComctlLib.ImageList iglProcess 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTRF001.frx":32E7
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTRF001.frx":3BC1
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTRF001.frx":4013
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTRF001.frx":4465
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTRF001.frx":477F
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTRF001.frx":4BD1
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTRF001.frx":5023
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTRF001.frx":533D
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTRF001.frx":5657
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTRF001.frx":5AA9
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTRF001.frx":6385
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTRF001.frx":66AD
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin TrueDBGrid60.TDBGrid tblDetail 
      Height          =   4155
      Left            =   120
      OleObjectBlob   =   "frmTRF001.frx":69CD
      TabIndex        =   8
      Top             =   3840
      Width           =   11535
   End
...
Private Const UpdFlg = 11
Private Const ITMID = 12
Private Const SOID = 13
...
Private Function LoadRecord() As Boolean
    ...
    Do While Not rsInvoice.EOF
        If ReadRs(rsInvoice, "SJDTTRNTYPE") = "STKIN" Then
            cboWhsCodeTo = ReadRs(rsInvoice, "SJDTWHSCODE")
    ...
    txtRmk = ReadRs(rsInvoice, "SJHDREMARK")
    txtRmk2 = ReadRs(rsInvoice, "SJHDREMARK2")
    txtRmk3 = ReadRs(rsInvoice, "SJHDREMARK3")
    ...
    lblDspWhsFr = Get_TableInfo("MstWarehouse", "WhsCode ='" & cboWhsCodeFr & "'", "WHSDESC")
    lblDspWhsTo = Get_TableInfo("MstWarehouse", "WhsCode ='" & cboWhsCodeTo & "'", "WHSDESC")
...
'            wdSOHqty = Get_StockAvailable(ReadRs(rsInvoice, "SJDTITEMID"), cboWhsCodeFr.Text, "")
            ...
            waResult(.UpperBound(1), LOTTO) = wsLotTo
            waResult(.UpperBound(1), SOH) = Format(wdSOHqty, gsQtyFmt)
            ...
            waResult(.UpperBound(1), UpdFlg) = ReadRs(rsInvoice, "SJDTUPDFLG")
            rsInvoice.MoveNext
        Loop
...
On Error GoTo Ini_Caption_Err
    ...
    btnITMLST.Caption = Get_Caption(waScrItm, "ITMLST")
    ...
    If waResult.UpperBound(1) >= 0 Then
        ...
        For wiCtr = 0 To waResult.UpperBound(1)
            If Trim(waResult(wiCtr, ITMCODE)) <> "" Then
                ...
                Call SetSPPara(adcmdSave, 5, waResult(wiCtr, QTY) * -1)
                ...
                Call SetSPPara(adcmdSave, 10, waResult(wiCtr, NET) * -1)
                Call SetSPPara(adcmdSave, 11, waResult(wiCtr, NET))
                Call SetSPPara(adcmdSave, 12, "STKOUT")
                Call SetSPPara(adcmdSave, 13, IIf(wlRowCtr = wiCtr, "Y", "N"))
                Call SetSPPara(adcmdSave, 14, waResult(wiCtr, UpdFlg))
        ...
        For wiCtr = 0 To waResult.UpperBound(1)
            If Trim(waResult(wiCtr, ITMCODE)) <> "" Then
                ...
                Call SetSPPara(adcmdSave, 8, waResult(wiCtr, LOTTO))
                Call SetSPPara(adcmdSave, 9, waResult(wiCtr, PRICE))
                Call SetSPPara(adcmdSave, 10, waResult(wiCtr, NET))
                Call SetSPPara(adcmdSave, 11, waResult(wiCtr, NET))
    ...
    With tblDetail
        Select Case ColIndex
            ...
            Case ITMCODE
                ...
                If Chk_grdITMCODE(.Columns(ColIndex).Text, .Columns(ITMTYPE).Text, wsITMID, wsITMCODE, "", wsITMNAME, wsPub, wdPrice, wdDisPer, wsWhsCode, wsLotNo, wdQty) = False Then
                   GoTo Tbl_BeforeColUpdate_Err
                End If
                
                'wdSOHqty = Get_StockAvailable(wsITMID, cboWhsCodeFr.Text, "")
                
               wdSOHqty = Get_IcTrnQty("INOUT", wsITMID, cboWhsCodeFr.Text, "")
               ...
               ' .Columns(LOTTO).Text = wsLOTTO
                ...
                .Columns(SOH).Text = Format(wdSOHqty, gsQtyFmt)
             ...
             Case LOTNO
                ...
                If Chk_grdLotNo(cboWhsCodeFr.Text, .Columns(ColIndex).Text) = False Then
                        GoTo Tbl_BeforeColUpdate_Err
                End If
                
                If Chk_LotEnabled(cboWhsCodeFr.Text) = True Then
                     .Columns(SOH).Text = Get_IcTrnQty("INOUT", .Columns(ITMID).Text, cboWhsCodeFr.Text, .Columns(ColIndex).Text)
                End If
             ...
             Case LOTTO
                ...
                If Chk_grdLotNo(cboWhsCodeTo.Text, .Columns(ColIndex).Text) = False Then
                        GoTo Tbl_BeforeColUpdate_Err
                End If
...
Private Function Chk_grdITMCODE(inAccNo As String, inItmType As String, outAccID As String, outAccNo As String, OutLOTTO As String, OutName As String, outPub As String, outPrice As Double, outDisPer As Double, outWhsCode As String, outLotNo As String, outQty As Double) As Boolean
...
Private Function Chk_GrdRow(ByVal LastRow As Long) As Boolean
    ...
    With tblDetail
        ...
        If Chk_grdLotNo(cboWhsCodeFr.Text, waResult(LastRow, LOTNO)) = False Then
                .Col = LOTNO
                .Row = LastRow
                Exit Function
        End If
        
        If Chk_grdLotNo(cboWhsCodeTo.Text, waResult(LastRow, LOTTO)) = False Then
                .Col = LOTTO
                .Row = LastRow
                Exit Function
        End If
...
Private Function Chk_TrfUpd(ByVal CRow As Long) As Boolean
    Dim wsSQL As String
