...
Begin VB.Form frmIM003 
   Caption         =   "Upload Stock Out"
   ClientHeight    =   4680
   ClientLeft      =   45
   ClientTop       =   270
   ClientWidth     =   9270
   Icon            =   "frmIM003.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   ScaleHeight     =   4680
   ...
   Begin MSComctlLib.ImageList iglProcess 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmIM003.frx":030A
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmIM003.frx":0BE4
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmIM003.frx":14BE
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmIM003.frx":1910
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmIM003.frx":1D62
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmIM003.frx":207C
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmIM003.frx":24CE
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmIM003.frx":2920
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmIM003.frx":2C3A
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmIM003.frx":2F54
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmIM003.frx":33A6
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmIM003.frx":3C82
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Private Sub Ini_Scr()
   ...
   If InStr(gsExcPath, ":\") Or InStr(gsExcPath, "\\") Then
    ...
    txtFilePath(inPath).Text = wsExcelPath & "StockOut.xls"
...
Private Sub Form_Unload(Cancel As Integer)
   ...
   Set frmIM003 = Nothing

End Sub

Private Sub Ini_Caption()

   Call Get_Scr_Item("IM003", waScrItm)
...
Private Function LoadExcelData() As Boolean
    ...
    With xlApp.Worksheets(1)
        Do While Trim(.Cells(wiRow, DocNo).Value) <> ""
            wsSql = " EXEC USP_RPTIM003 '" & gsUserID & "', '" & wsGenDte & "', "
            wsSql = wsSql & wiRow & ", "
...
Private Function UpdateStockOut() As Boolean
    Dim adComand As New ADODB.Command
    
    On Error GoTo UpdateStockOut_Err
    
    UpdateStockOut = False
    
    cnCon.BeginTrans
    Set adComand.ActiveConnection = cnCon
        
    adComand.CommandText = "USP_UPDSTKOUT"
