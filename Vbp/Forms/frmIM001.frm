...
Begin VB.Form frmIM001 
   Caption         =   "Upload Stock Balance "
   ClientHeight    =   4680
   ClientLeft      =   45
   ClientTop       =   270
   ClientWidth     =   9270
   Icon            =   "frmIM001.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   ScaleHeight     =   4680
   ...
   Begin MSComctlLib.ImageList iglProcess 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmIM001.frx":030A
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmIM001.frx":0BE4
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmIM001.frx":14BE
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmIM001.frx":1910
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmIM001.frx":1D62
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmIM001.frx":207C
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmIM001.frx":24CE
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmIM001.frx":2920
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmIM001.frx":2C3A
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmIM001.frx":2F54
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmIM001.frx":33A6
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmIM001.frx":3C82
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Private Const StrCol = 1
Private Const EndCol = 73

Private Const ELine = 1
Private Const EItmCode = 2
Private Const EItmNam = 3
Private Const EErrMsg = 4
...
Private Sub Ini_Scr()
   ...
   If InStr(gsExcPath, ":\") Or InStr(gsExcPath, "\\") Then
    ...
    txtFilePath(inPath).Text = wsExcelPath & "BookMaster.xls"
...
Private Sub Form_Unload(Cancel As Integer)
   ...
   Set frmIM001 = Nothing

End Sub

Private Sub Ini_Caption()

    Call Get_Scr_Item("IM001", waScrItm)
...
Private Function PrintErrorSheet() As Boolean
    ...
    PrintErrorSheet = False
        ...
        wsSql = " SELECT RPTLINE, RPTITMCODE, RPTITMNAM, RPTERRMSG "
    ...
    xlApp.Visible = False
        ...
        StartRow = 3
        ArrayRow = 0
        xlApp.Workbooks.Open wsExcelPath & "ERROR.XLS", ReadOnly:=True
...
Private Function LoadExcelData() As Boolean
    ...
    With xlApp.Worksheets(1)
        Do While Trim(.Cells(wiRow, StrCol).Value) <> ""
            wsSql = " EXEC USP_RPTIMITEM '" & gsUserID & "', '" & wsGenDte & "', "
            wsSql = wsSql & wiRow & ", "
            For wiCtr = StrCol To EndCol
            wsSql = wsSql & "'" & IIf(Len(Trim(.Cells(wiRow, wiCtr).Value)) <= 60, Set_Quote(Trim(.Cells(wiRow, wiCtr).Value)), Set_Quote(Left(Trim(.Cells(wiRow, wiCtr).Value), 60))) & "', "
            Next wiCtr
...
Private Function UpdateStockBalance() As Boolean
    Dim adComand As New ADODB.Command
    
    On Error GoTo UpdateStockBalance_Err
    ...
    adComand.CommandText = "USP_UPDSTKBAL"
