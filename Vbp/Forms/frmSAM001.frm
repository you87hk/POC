...
Begin VB.Form frmSAM001 
   Caption         =   "訂貨單"
   ClientHeight    =   8595
   ClientLeft      =   1.96650e5
   ClientTop       =   270
   ClientWidth     =   11880
   Icon            =   "frmSAM001.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   8595
   ScaleWidth      =   11880
   ...
   Begin TrueDBGrid60.TDBGrid tblCommon 
      Height          =   2070
      Left            =   9360
      OleObjectBlob   =   "frmSAM001.frx":030A
      TabIndex        =   12
      Top             =   2280
      Visible         =   0   'False
      Width           =   5055
   ...
   Begin MSComctlLib.ImageList iglProcess 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSAM001.frx":2A0D
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSAM001.frx":32E7
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSAM001.frx":3BC1
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSAM001.frx":4013
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSAM001.frx":4465
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSAM001.frx":477F
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSAM001.frx":4BD1
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSAM001.frx":5023
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSAM001.frx":533D
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSAM001.frx":5657
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSAM001.frx":5AA9
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSAM001.frx":6385
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSAM001.frx":66AD
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin TrueDBGrid60.TDBGrid tblDetail 
      Height          =   3675
      Left            =   120
      OleObjectBlob   =   "frmSAM001.frx":69CD
      TabIndex        =   11
      Top             =   4320
      Width           =   11535
   End
...
Private Sub Ini_Scr_AfrKey()
    ...
    If LoadRecord() = False Then
        ...
        cboCusCode.SetFocus
        cboMLCode = Get_CompanyFlag("CmpSamMLCode")
    Else
        wiAction = CorRec
...
Private Sub cboWhsCodeFr_KeyPress(KeyAscii As Integer)
    ...
    If KeyAscii = vbKeyReturn Then
       ...
       lblDspWhsDesc = Get_TableInfo("MstWarehouse", "WHSCODE = '" & Set_Quote(cboWhsCodeFr.Text) & "'", "WHSDESC")
       cboMLCode.SetFocus
...
Private Function LoadRecord() As Boolean
    ...
    lblDspCusDesc = Get_TableInfo("MstCustomer", "CUSID = " & CStr(wlCusID), "CusName")
...
Private Sub cboCusCode_DropDown()
    ...
    wsSQL = "SELECT CUSCODE, CUSNAME FROM MstCustomer WHERE CusCode LIKE '%" & IIf(cboCusCode.SelLength > 0, "", Set_Quote(cboCusCode.Text)) & "%' "
    wsSQL = wsSQL & "AND CusStatus = '1' "
    wsSQL = wsSQL & "AND CusInactive = 'N' "
    wsSQL = wsSQL & "ORDER BY CusCode "
    Call Ini_Combo(2, wsSQL, cboCusCode.Left, cboCusCode.Top + cboCusCode.Height, tblCommon, wsFormID, "TBLCUSCOD", Me.Width, Me.Height)
...
Private Function chk_cboCusCode() As Boolean
    ...
    If Chk_CusCode(cboCusCode, wlCusID, wsDesc, "", "") = False Then
        gsMsg = "沒有此客戶!"
        MsgBox gsMsg, vbOKOnly, gsTitle
        cboCusCode.SetFocus
        lblDspCusDesc = ""
