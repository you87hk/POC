...
Begin VB.Form frmSN001 
   Caption         =   "訂貨單"
   ClientHeight    =   8595
   ClientLeft      =   1.96650e5
   ClientTop       =   270
   ClientWidth     =   11880
   Icon            =   "frmSN001.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   ScaleHeight     =   8595
   ScaleWidth      =   11880
   ...
   Begin TrueDBGrid60.TDBGrid tblCommon 
      Height          =   2070
      Left            =   10560
      OleObjectBlob   =   "frmSN001.frx":030A
      TabIndex        =   40
      Top             =   3480
      Visible         =   0   'False
      Width           =   4575
   ...
   Begin MSComctlLib.ImageList iglProcess 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSN001.frx":2A0D
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSN001.frx":32E7
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSN001.frx":3BC1
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSN001.frx":4013
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSN001.frx":4465
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSN001.frx":477F
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSN001.frx":4BD1
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSN001.frx":5023
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSN001.frx":533D
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSN001.frx":5657
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSN001.frx":5AA9
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSN001.frx":6385
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSN001.frx":66AD
            Key             =   ""
         EndProperty
         BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSN001.frx":69C9
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin TabDlg.SSTab tabDetailInfo 
      ...
      TabPicture(0)   =   "frmSN001.frx":6CE5
      ...
      Tab(0).Control(13)=   "txtDisAmt"
      Tab(0).Control(13).Enabled=   0   'False
      Tab(0).Control(14)=   "btnGetDisAmt"
      Tab(0).Control(14).Enabled=   0   'False
      Tab(0).Control(15)=   "cboCRML"
      Tab(0).Control(15).Enabled=   0   'False
      Tab(0).ControlCount=   16
      TabCaption(1)   =   "Shipment "
      TabPicture(1)   =   "frmSN001.frx":6D01
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "Frame1"
      Tab(1).Control(1)=   "tblDetail"
      Tab(1).Control(2)=   "lblCol(9)"
      Tab(1).Control(3)=   "lblDspCstAmtOrg"
      Tab(1).Control(4)=   "lblCol(2)"
      Tab(1).Control(5)=   "lblCol(1)"
      Tab(1).Control(6)=   "lblCol(4)"
      Tab(1).Control(7)=   "lblCol(6)"
      Tab(1).Control(8)=   "lblDspDisAmtOrg"
      Tab(1).Control(9)=   "lblDisAmtOrg"
      Tab(1).Control(10)=   "lblCol(10)"
      Tab(1).Control(11)=   "lblCol(8)"
      Tab(1).Control(12)=   "lblCol(7)"
      Tab(1).Control(13)=   "lblCol(5)"
      Tab(1).Control(14)=   "lblCol(3)"
      Tab(1).Control(15)=   "lblCol(0)"
      ...
      TabPicture(2)   =   "frmSN001.frx":6D1D
      ...
      Begin TrueDBGrid60.TDBGrid tblDetail 
         Height          =   5895
         Left            =   -74880
         OleObjectBlob   =   "frmSN001.frx":717B
         TabIndex        =   21
         Top             =   1260
         Width           =   11535
      End
...
Private Const wsKeyType = "SOASNHD"
...
Private Sub cboDocNo_DropDown()
    ...
    wsSQL = wsSQL & " WHERE SNHDDOCNO LIKE '%" & IIf(cboDocNo.SelLength > 0, "", Set_Quote(cboDocNo.Text)) & "%' "
    wsSQL = wsSQL & " AND SNHDCUSID  = CUSID "
    wsSQL = wsSQL & " AND SNHDSTATUS  IN ('1','4') "
    wsSQL = wsSQL & " AND SNHDCTLPRD  BETWEEN '" & Str(Val(Left(gsSystemDate, 4)) - 1) + "01" & "' AND '" & Left(gsSystemDate, 4) + "12" & "'"
...
Private Function LoadRecord() As Boolean
    ...
    wsSQL = wsSQL & "WHERE SNHDDOCNO = '" & Set_Quote(cboDocNo) & "' "
    ...
    lblDspRevNo.Caption = Format(ReadRs(rsInvoice, "SNHDREVNO"), "##0")
   ' wiRevNo = To_Value(ReadRs(rsInvoice, "SNHDREVNO"))
    ...
    cboPayCode = ReadRs(rsInvoice, "SNHDPAYCODE")
    cboPrcCode = ReadRs(rsInvoice, "SNHDPRCCODE")
    cboMLCode = ReadRs(rsInvoice, "SNHDMLCODE")
    cboCRML = ReadRs(rsInvoice, "SNHDNATURECODE")
    

    cboShipCode = ReadRs(rsInvoice, "SNHDSHIPCODE")
    cboRmkCode = ReadRs(rsInvoice, "SNHDRMKCODE")
    
    txtCusPo = ReadRs(rsInvoice, "SNHDCUSPO")
    txtLcNo = ReadRs(rsInvoice, "SNHDLCNO")
    txtPortNo = ReadRs(rsInvoice, "SNHDPORTNO")
    txtSpecDis.Text = Format(ReadRs(rsInvoice, "SNHDSPECDIS"), gsAmtFmt)
    
    txtShipFrom = ReadRs(rsInvoice, "SNHDSHIPFROM")
    txtShipTo = ReadRs(rsInvoice, "SNHDSHIPTO")
    txtShipVia = ReadRs(rsInvoice, "SNHDSHIPVIA")
    txtShipName = ReadRs(rsInvoice, "SNHDSHIPNAME")
    txtShipPer = ReadRs(rsInvoice, "SNHDSHIPPER")
    txtShipAdr1 = ReadRs(rsInvoice, "SNHDSHIPADR1")
    txtShipAdr2 = ReadRs(rsInvoice, "SNHDSHIPADR2")
    txtShipAdr3 = ReadRs(rsInvoice, "SNHDSHIPADR3")
    txtShipAdr4 = ReadRs(rsInvoice, "SNHDSHIPADR4")
    ...
    For i = 1 To 10
        txtRmk(i) = ReadRs(rsInvoice, "SNHDRMK" & i)
    Next i
    ...
    lblDspGrsAmtOrg.Caption = Format(To_Value(ReadRs(rsInvoice, "SNHDGRSAMT")), gsAmtFmt)
    lblDspDisAmtOrg.Caption = Format(To_Value(ReadRs(rsInvoice, "SNHDDISAMT")), gsAmtFmt)
    lblDspNetAmtOrg.Caption = Format(To_Value(ReadRs(rsInvoice, "SNHDNETAMT")), gsAmtFmt)
    ...
    With waResult
         ...
         Do While Not rsInvoice.EOF
           ...
           '  waResult(.UpperBound(1), GITMCODE) = IIf(To_Value(ReadRs(rsInvoice, "SNPTJITEMID")) = 0, "", Get_TableInfo("MSTITEM", "ITMID = " & To_Value(ReadRs(rsInvoice, "SNPTJITEMID")), "ITMCODE"))
             waResult(.UpperBound(1), GDESC1) = ReadRs(rsInvoice, "SNPTJDESC1")
             waResult(.UpperBound(1), GQTY) = Format(ReadRs(rsInvoice, "SNPTJQTY"), gsQtyFmt)
             waResult(.UpperBound(1), GPRICE) = Format(ReadRs(rsInvoice, "SNPTJDPRICE"), gsAmtFmt)
             waResult(.UpperBound(1), GDISPER) = Format(ReadRs(rsInvoice, "SNPTJDISPER"), gsAmtFmt)
             waResult(.UpperBound(1), GMARKUP) = Format(ReadRs(rsInvoice, "SNPTJMARKUP"), gsAmtFmt)
             waResult(.UpperBound(1), GUOM) = ReadRs(rsInvoice, "SNPTJUOM")
             
             waResult(.UpperBound(1), GUCST) = Format(ReadRs(rsInvoice, "SNPTJUCST"), gsAmtFmt)
             waResult(.UpperBound(1), GAMT) = Format(ReadRs(rsInvoice, "SNPTJUPRICE"), gsAmtFmt)
             waResult(.UpperBound(1), GNET) = Format(ReadRs(rsInvoice, "SNPTJNET"), gsAmtFmt)
             waResult(.UpperBound(1), GCST) = Format(ReadRs(rsInvoice, "SNPTJCST"), gsAmtFmt)
             ...
             waResult(.UpperBound(1), GDRMKID) = To_Value(ReadRs(rsInvoice, "SNPTJDRMKID"))
             waResult(.UpperBound(1), GMORE) = IIf(To_Value(ReadRs(rsInvoice, "SNPTJDRMKID")) <> 0, "Y", "N")
             
             waResult(.UpperBound(1), GPRINT) = IIf(ReadRs(rsInvoice, "SNPTJPRTFLG") = "Y", "-1", "0")
...
Private Function Chk_KeyExist() As Boolean
    ...
    rsSOASNHD.Open wsSQL, cnCon, adOpenStatic, adLockOptimistic
    ...
    If waResult.UpperBound(1) >= 0 Then
        ...
        For wiCtr = 0 To waResult.UpperBound(1)
            If Trim(waResult(wiCtr, GQTY)) <> "" Then
                ...
                Call SetSPPara(adcmdSave, 21, IIf(waResult(wiCtr, GPRINT) = "-1", "Y", "N"))
  ...
  '  waItem.ReDim 0, waResult.UpperBound(1), SLINENO, SITMID
    ...
    Do Until rsRcd.EOF
       ...
       ' waItem(.UpperBound(1), SINDENT) = IIf(ReadRs(rsRcd, "SNDTLNTYPE") = "T", "-1", "0")
        waItem(.UpperBound(1), SINDENT) = ReadRs(rsRcd, "SNDTLNTYPE")
        ...
        waItem(.UpperBound(1), SITMNAME) = IIf(ReadRs(rsRcd, "SNDTLNTYPE") = "S", ReadRs(rsRcd, "SNDTITEMDESC"), ReadRs(rsRcd, "ITMNAME"))
        waItem(.UpperBound(1), SUNITPRICE) = Format(ReadRs(rsRcd, "SNDTUPRICE"), gsUprFmt)
        waItem(.UpperBound(1), SUCST) = Format(ReadRs(rsRcd, "SNDTUCST"), gsUprFmt)
        
        waItem(.UpperBound(1), SDISPER) = Format(ReadRs(rsRcd, "SNDTDISPER"), gsAmtFmt)
        
        waItem(.UpperBound(1), SQTY) = Format(ReadRs(rsRcd, "SNDTQTY"), gsQtyFmt)
        waItem(.UpperBound(1), SAMT) = Format(ReadRs(rsRcd, "SNDTAMT"), gsAmtFmt)
        waItem(.UpperBound(1), SNET) = Format(ReadRs(rsRcd, "SNDTNET"), gsAmtFmt)
        waItem(.UpperBound(1), SCST) = Format(ReadRs(rsRcd, "SNDTCST"), gsAmtFmt)
        
        waItem(.UpperBound(1), SITMID) = To_Value(ReadRs(rsRcd, "SNDTITEMID"))
        waItem(.UpperBound(1), SVDRID) = To_Value(ReadRs(rsRcd, "SNDTVDRID"))
