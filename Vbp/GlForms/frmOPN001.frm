...
Begin VB.Form frmOPN001 
   Caption         =   "OPN001"
   ClientHeight    =   8595
   ClientLeft      =   1.96650e5
   ClientTop       =   -15
   ClientWidth     =   11880
   Icon            =   "frmOPN001.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   ScaleHeight     =   8595
   ScaleWidth      =   11880
   ...
   Begin MSComctlLib.ImageList iglProcess 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmOPN001.frx":030A
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmOPN001.frx":0BE4
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmOPN001.frx":14BE
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmOPN001.frx":1910
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmOPN001.frx":1D62
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmOPN001.frx":207C
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmOPN001.frx":24CE
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmOPN001.frx":2920
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmOPN001.frx":2C3A
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmOPN001.frx":2F54
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmOPN001.frx":33A6
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmOPN001.frx":3C82
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmOPN001.frx":3FAA
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin TrueDBGrid60.TDBGrid tblDetail 
      Height          =   7455
      Left            =   120
      OleObjectBlob   =   "frmOPN001.frx":42C6
      TabIndex        =   3
      Top             =   1080
      Width           =   11775
   End
...
Private Const COAACCCODE = 0
Private Const COADESC = 1
Private Const COAOPNBAL = 2
Private Const COAACCID = 3
   ...
   ' End If
    ...
    If waResult.UpperBound(1) >= 0 Then
        ...
        For wiCtr = 0 To waResult.UpperBound(1)
            If Trim(waResult(wiCtr, COAACCCODE)) <> "" Then
                Call SetSPPara(adcmdSave, 1, lblDspYear.Caption)
                Call SetSPPara(adcmdSave, 2, waResult(wiCtr, COAACCID))
                Call SetSPPara(adcmdSave, 3, waResult(wiCtr, COAOPNBAL))
...
Private Function InputValidation() As Boolean
    ...
    With waResult
        For wlCtr = 0 To .UpperBound(1)
            If Trim(waResult(wlCtr, COAOPNBAL)) <> "" Then
                wiEmptyGrid = False
    ...
    With tblDetail
        Select Case ColIndex
            Case COAOPNBAL
                ...
                .Columns(COAOPNBAL).Text = Format(.Columns(COAOPNBAL).Text, gsAmtFmt)
            End Select
    End With
...
Private Function IsEmptyRow(Optional inRow) As Boolean
    IsEmptyRow = True
        ...
        If IsMissing(inRow) Then
            With tblDetail
                If Trim(.Columns(COAOPNBAL)) = "" Then
                    Exit Function
                End If
            End With
        Else
            If waResult.UpperBound(1) >= 0 Then
                If Trim(waResult(inRow, COAACCCODE)) = "" And _
                   Trim(waResult(inRow, COADESC)) = "" And _
                   Trim(waResult(inRow, COAOPNBAL)) = "" Then
                   Exit Function
                End If
            End If
        End If
...
Private Function Chk_GrdRow(ByVal LastRow As Long) As Boolean
    ...
    With tblDetail
        ...
        If Chk_grdBal(waResult(LastRow, COAOPNBAL)) = False Then
            .Col = COAOPNBAL
            .Row = LastRow
            Exit Function
        End If
...
Private Function LoadRecord() As Boolean
    ...
    With waResult
         ...
         Do While Not rsRcd.EOF
             wiCtr = wiCtr + 1
             .AppendRows
             waResult(.UpperBound(1), COAACCCODE) = ReadRs(rsRcd, "COAACCCODE")
             waResult(.UpperBound(1), COADESC) = ReadRs(rsRcd, "COADESC")
             waResult(.UpperBound(1), COAOPNBAL) = ReadRs(rsRcd, "COAOPNBAL")
             waResult(.UpperBound(1), COAACCID) = ReadRs(rsRcd, "COAACCID")
             rsRcd.MoveNext
         Loop
