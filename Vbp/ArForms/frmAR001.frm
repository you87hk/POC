...
Begin VB.Form frmAR001 
   Caption         =   "訂貨單"
   ClientHeight    =   6615
   ClientLeft      =   1.96650e5
   ClientTop       =   270
   ClientWidth     =   9795
   Icon            =   "frmAR001.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   ScaleHeight     =   6615
   ScaleWidth      =   9795
   ...
   Begin TrueDBGrid60.TDBGrid tblCommon 
      Height          =   2070
      Left            =   9840
      OleObjectBlob   =   "frmAR001.frx":030A
      TabIndex        =   22
      Top             =   240
      Visible         =   0   'False
      Width           =   4575
   ...
   Begin MSComctlLib.ImageList iglProcess 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAR001.frx":2A0D
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAR001.frx":32E7
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAR001.frx":3BC1
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAR001.frx":4013
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAR001.frx":4465
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAR001.frx":477F
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAR001.frx":4BD1
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAR001.frx":5023
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAR001.frx":533D
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAR001.frx":5657
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAR001.frx":5AA9
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAR001.frx":6385
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin TabDlg.SSTab tabDetailInfo 
      ...
      TabPicture(0)   =   "frmAR001.frx":66AD
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "lblDueDate"
      Tab(0).Control(1)=   "lblDspSaleDesc"
      Tab(0).Control(2)=   "lblSaleCode"
      Tab(0).Control(3)=   "lblDspPayDesc"
      Tab(0).Control(4)=   "lblPayCode"
      Tab(0).Control(5)=   "lblDspMLDesc"
      Tab(0).Control(6)=   "lblMlCode"
      Tab(0).Control(7)=   "lblRmkCode"
      Tab(0).Control(8)=   "lblRmk"
      Tab(0).Control(9)=   "medDueDate"
      Tab(0).Control(10)=   "cboSaleCode"
      Tab(0).Control(11)=   "cboMLCode"
      Tab(0).Control(12)=   "cboPayCode"
      Tab(0).Control(13)=   "cboRmkCode"
      Tab(0).Control(14)=   "picRmk"
      Tab(0).ControlCount=   15
      TabCaption(1)   =   "Shipment "
      TabPicture(1)   =   "frmAR001.frx":66C9
      ...
      Begin TrueDBGrid60.TDBGrid tblDetail 
         Height          =   3375
         Left            =   120
         OleObjectBlob   =   "frmAR001.frx":66E5
         TabIndex        =   16
         Top             =   120
         Width           =   9495
      End
...
Private Const wsKeyType = "ARINHD"
...
Private Sub cboDocNo_DropDown()
    ...
    wsSQL = wsSQL & " WHERE INHDDOCNO LIKE '%" & IIf(cboDocNo.SelLength > 0, "", Set_Quote(cboDocNo.Text)) & "%' "
...
Private Function LoadRecord() As Boolean
  ...
  '      wsSql = wsSql & "AND INHDPGMNO = '" & wsFormID & "'"
    ...
    txtRevNo.Text = Format(ReadRs(rsRcd, "INHDREVNO") + 1, "##0")
    ...
    txtExcr.Text = Format(ReadRs(rsRcd, "INHDEXCR"), gsExrFmt)
    
    medDueDate.Text = Dsp_MedDate(ReadRs(rsRcd, "INHDDUEDATE"))
    
    wlSaleID = To_Value(ReadRs(rsRcd, "INHDSALEID"))
     
    cboPayCode = ReadRs(rsRcd, "INHDPAYCODE")
    cboMLCode = ReadRs(rsRcd, "INHDMLCODE")
    cboRmkCode = ReadRs(rsRcd, "INHDRMKCODE")
    
    cboJobNo = ReadRs(rsRcd, "INHDJOBNO")
    
    
    Dim i As Integer
    
    For i = 1 To 5
        txtRmk(i) = ReadRs(rsRcd, "INHDRMK" & i)
    Next i
    ...
    With waResult
         ...
         Do While Not rsRcd.EOF
             wiCtr = wiCtr + 1
             .AppendRows
             waResult(.UpperBound(1), GMLCODE) = ReadRs(rsRcd, "INDTMLCODE")
             waResult(.UpperBound(1), GDESC) = ReadRs(rsRcd, "INDTDESC")
             waResult(.UpperBound(1), GCUSPO) = ReadRs(rsRcd, "INDTCUSPO")
             waResult(.UpperBound(1), GJOBNO) = ReadRs(rsRcd, "INDTJOBNO")
             waResult(.UpperBound(1), GAMT) = IIf(wsTrnCd = "60", Format(ReadRs(rsRcd, "INDTINVAMT") * -1, gsAmtFmt), Format(ReadRs(rsRcd, "INDTINVAMT"), gsAmtFmt))
             waResult(.UpperBound(1), GDTLID) = ReadRs(rsRcd, "INDTID")
             rsRcd.MoveNext
         Loop
    End With
    tblDetail.ReBind
...
Private Function Chk_KeyExist() As Boolean
    ...
    wsSQL = "SELECT INHDSTATUS FROM ARINHD WHERE INHDDOCNO = '" & Set_Quote(cboDocNo) & "'"
    rsRcd.Open wsSQL, cnCon, adOpenStatic, adLockOptimistic
    If rsRcd.RecordCount > 0 Then
    ...
    If waResult.UpperBound(1) >= 0 Then
        ...
        For wiCtr = 0 To waResult.UpperBound(1)
            If Trim(waResult(wiCtr, GMLCODE)) <> "" Then
                ...
                wdTmpAmt = NBRnd(IIf(wsTrnCd = "60", To_Value(waResult(wiCtr, GAMT)) * -1, To_Value(waResult(wiCtr, GAMT))), giAmtDp)
                Call SetSPPara(adcmdSave, 8, wdTmpAmt)
                wdTmpAmt = NBRnd(IIf(wsTrnCd = "60", To_Value(waResult(wiCtr, GAMT)) * To_Value(txtExcr.Text) * -1, To_Value(waResult(wiCtr, GAMT)) * To_Value(txtExcr.Text)), giAmtDp)
...
Dim wsDesc As String
    ...
    If Chk_MLClass(cboMLCode, "A", wsDesc) = False Then
        gsMsg = "沒有此會計分類!"
        MsgBox gsMsg, vbOKOnly, gsTitle
        tabDetailInfo.Tab = 0
        cboMLCode.SetFocus
