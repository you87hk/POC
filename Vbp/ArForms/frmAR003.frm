...
Begin VB.Form frmAR003 
   Caption         =   "訂貨單"
   ClientHeight    =   6615
   ClientLeft      =   1.96650e5
   ClientTop       =   270
   ClientWidth     =   9795
   Icon            =   "frmAR003.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   ScaleHeight     =   6615
   ScaleWidth      =   9795
   ...
   Begin TrueDBGrid60.TDBGrid tblCommon 
      Height          =   2070
      Left            =   9840
      OleObjectBlob   =   "frmAR003.frx":030A
      TabIndex        =   16
      Top             =   240
      Visible         =   0   'False
      Width           =   4575
   ...
   Begin MSComctlLib.ImageList iglProcess 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAR003.frx":2A30
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAR003.frx":330A
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAR003.frx":3BE4
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAR003.frx":4036
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAR003.frx":4488
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAR003.frx":47A2
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAR003.frx":4BF4
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAR003.frx":5046
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAR003.frx":5360
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAR003.frx":567A
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAR003.frx":5ACC
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAR003.frx":63A8
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin TabDlg.SSTab tabDetailInfo 
      ...
      TabPicture(0)   =   "frmAR003.frx":66D0
      ...
      TabPicture(1)   =   "frmAR003.frx":66EC
      ...
      Begin TrueDBGrid60.TDBGrid tblDetail 
         Height          =   1815
         Left            =   -74880
         OleObjectBlob   =   "frmAR003.frx":6708
         TabIndex        =   11
         Top             =   120
         Width           =   9495
      End
      Begin TrueDBGrid60.TDBGrid tblInvoice 
         Height          =   1815
         Left            =   120
         OleObjectBlob   =   "frmAR003.frx":C1C3
         TabIndex        =   10
         Top             =   120
         Width           =   9495
      End
...
Private Const wsKeyType = "ARSTHD"
Private Const wsInvKeyType = "ARINHD"   'Use for the locking
...
Private Sub cboDocNo_DropDown()
    ...
    wsSQL = wsSQL & " WHERE ARSHDOCNO LIKE '%" & IIf(cboDocNo.SelLength > 0, "", Set_Quote(cboDocNo.Text)) & "%' "
...
Private Function LoadRecord() As Boolean
    ...
    txtExcr.Text = Format(ReadRs(rsRcd, "ARSHEXCR"), gsExrFmt)
    txtChqAmtOrg.Text = NBRnd(ReadRs(rsRcd, "ARSHCHQAMT"), giAmtDp)
    If To_Value(txtChqAmtOrg.Text) > 0 Then Call SetFieldStatus("RemTrue")
    LblDspChqAmtLoc.Caption = NBRnd(ReadRs(rsRcd, "ARSHCHQAMTL"), giAmtDp)
    
   
    cboMLCode = ReadRs(rsRcd, "ARSHMLCODE")
    txtRmk = ReadRs(rsRcd, "ARSHREMARK")
    ...
    With waInvoice
         ...
         Do While Not rsRcd.EOF
             .AppendRows
             waInvoice(.UpperBound(1), IINVNO) = ReadRs(rsRcd, "INHDDOCNO")
             waInvoice(.UpperBound(1), ILINE) = Format(To_Value(ReadRs(rsRcd, "INDTDOCLINE")), "000")
             waInvoice(.UpperBound(1), ICURR) = ReadRs(rsRcd, "ARSDCURR")
             waInvoice(.UpperBound(1), IEXCR) = ReadRs(rsRcd, "INHDEXCR")
             ...
             waInvoice(.UpperBound(1), IINDTID) = ReadRs(rsRcd, "INDTID")
             
            If NoMoreInvNo(waInvoice, ReadRs(rsRcd, "INHDDOCNO"), .UpperBound(1)) Then
    ...
    With waResult
         ...
         Do While Not rsRcd.EOF
             .AppendRows
             waResult(.UpperBound(1), OMLCODE) = ReadRs(rsRcd, "ARSDMLCODE")
             waResult(.UpperBound(1), OCURR) = ReadRs(rsRcd, "ARSDCURR")
             waResult(.UpperBound(1), OEXCR) = ReadRs(rsRcd, "ARSDEXCR")
             waResult(.UpperBound(1), OOTHAMTORG) = Format(To_Value(ReadRs(rsRcd, "ARSDTRNAMT")) * -1, gsAmtFmt)
             waResult(.UpperBound(1), OOTHAMTLOC) = Format(To_Value(ReadRs(rsRcd, "ARSDTRNAMTL")) * -1, gsAmtFmt)
    ...
    If rsRcd.RecordCount > 0 Then
       txtRemAmt.Text = NBRnd(0 - NBRnd(ReadRs(rsRcd, "ARSDTRNAMT"), giAmtDp), giAmtDp)
       lblDspRemAmtl.Caption = NBRnd(0 - NBRnd(ReadRs(rsRcd, "ARSDTRNAMTL"), giAmtDp), giAmtDp)
...
Private Function Chk_KeyExist() As Boolean
    ...
    wsSQL = "SELECT ARSHSTATUS FROM ARSTHD WHERE ARSHDOCNO = '" & Set_Quote(cboDocNo) & "'"
    rsRcd.Open wsSQL, cnCon, adOpenStatic, adLockOptimistic
    If rsRcd.RecordCount > 0 Then
    ...
    If waInvoice.UpperBound(1) >= 0 Then
        ...
        For wiCtr = 0 To waInvoice.UpperBound(1)
            If IsEmptyInvRow(wiCtr) = False Then
                Call SetSPPara(adcmdSave, 1, wiAction)
                Call SetSPPara(adcmdSave, 2, wlKey)
                Call SetSPPara(adcmdSave, 3, waInvoice(wiCtr, IINDTID))
...
Private Function Chk_InvNo(ByVal inInvNo As String, ByVal inInvLn As String, Optional inDtl As Boolean) As Boolean
    ...
    If IsMissing(inDtl) Then inDtl = False
        ...
        wsSQL = wsSQL & " AND  REPLICATE('0',3 - LEN(LTRIM(CONVERT(NVARCHAR(3),INDTDOCLINE))))  + CONVERT(NVARCHAR(3),INDTDOCLINE) = '" & Set_Quote(Format(inInvLn, "00#")) & "'"
        wsSQL = wsSQL & " AND INHDCUSID = " & wlCusID
