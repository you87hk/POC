...
Begin VB.Form frmAP002 
   Caption         =   "訂貨單"
   ClientHeight    =   4155
   ClientLeft      =   1.96650e5
   ClientTop       =   270
   ClientWidth     =   9795
   Icon            =   "frmAP002.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   ScaleHeight     =   4155
   ScaleWidth      =   9795
   ...
   Begin TrueDBGrid60.TDBGrid tblCommon 
      Height          =   2070
      Left            =   9840
      OleObjectBlob   =   "frmAP002.frx":030A
      TabIndex        =   13
      Top             =   240
      Visible         =   0   'False
      Width           =   4575
   ...
   Begin MSComctlLib.ImageList iglProcess 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAP002.frx":2A1C
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAP002.frx":32F6
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAP002.frx":3BD0
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAP002.frx":4022
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAP002.frx":4474
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAP002.frx":478E
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAP002.frx":4BE0
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAP002.frx":5032
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAP002.frx":534C
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAP002.frx":5666
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAP002.frx":5AB8
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAP002.frx":6394
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Private Const wsKeyType = "APCHEQUE"
...
Private Sub cboDocNo_DropDown()
    ...
    wsSQL = wsSQL & " WHERE APCQCHQNO LIKE '%" & IIf(cboDocNo.SelLength > 0, "", Set_Quote(cboDocNo.Text)) & "%' "
...
Private Function LoadRecord() As Boolean
    ...
    txtExcr.Text = Format(ReadRs(rsRcd, "APCQEXCR"), gsExrFmt)
    txtChqAmtOrg.Text = NBRnd(ReadRs(rsRcd, "APCQCHQAMT"), giAmtDp)
    cboMLCode = ReadRs(rsRcd, "APCQBANKML")
    cboTMPML = ReadRs(rsRcd, "APCQTMPML")
    txtRmk = ReadRs(rsRcd, "APCQREMARK")
...
Private Function Chk_KeyExist() As Boolean
    ...
    wsSQL = "SELECT APCQSTATUS FROM APCHEQUE WHERE APCQCHQNO = '" & Set_Quote(cboDocNo) & "'"
    rsRcd.Open wsSQL, cnCon, adOpenStatic, adLockOptimistic
    If rsRcd.RecordCount > 0 Then
...
Private Function Chk_VdrCode(ByVal InCusNo As String, ByRef OutID As Long, ByRef OutName As String, ByRef OutTel As String, ByRef OutFax As String) As Boolean
